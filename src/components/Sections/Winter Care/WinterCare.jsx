      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
          <div className="max-w-2xl">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-[#2d3a5e] leading-tight">
              Get Your Guitar Tuned in 3 Steps<span className="text-pink-500">.</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {steps.map((step) => (
            ...
            >
              <div className={`w-20 h-20 ${step.bgColor} rounded-3xl flex items-center justify-center mb-10 group-hover:rotate-12 transition-transform duration-500`}>
                <svg 
                  className={`w-10 h-10 ${step.colorClass}`} 
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24" 
                  strokeWidth="1.5"
